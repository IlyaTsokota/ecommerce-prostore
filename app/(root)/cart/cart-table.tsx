...
const CartTable: FC<CartTableProps> = ({ cart }) => {
    ...
    const handleRemoveItemFromCart = (productId: string) => {
        startTransition(async () => {
            const response = await removeItemFormCart(productId);
                        ...
                        <Table>
                            <TableHeader>
                                <TableRow>
                                    ...
                                    <TableHead className="text-center w-62.5">Quantity</TableHead>
                            ...
                            <TableBody>
                                {cart.items.map((item) => (
                                    <TableRow key={item.slug}>
                                        ...
                                        <TableCell className="flex-center gap-2 w-62.5">
                                            <Button
